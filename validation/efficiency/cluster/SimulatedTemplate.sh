...
#SBATCH --time=23:00:00       # The walltime
...
#SBATCH -D /nesi/project/nesi00390/rong/operator/simulated/output    # The initial directory
...
srun java -Xmx2800m -Djava.library.path=$BEAGLE_LIB_PATH -jar /nesi/project/nesi00390/rong/operator/ConstantDistanceOperator.jar -threads 8 -beagle_SSE /nesi/project/nesi00390/rong/operator/simulated/xml/FILE.xml
