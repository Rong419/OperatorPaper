...
\caption{\csentence{Correlation analysis in the ratites tree.}
             Blue indicates positive correlations and red indicates negative correlations. The darker the colour is, the stronger the correlation tends to be. $\tau $ represents the length of a branch, that is the time difference between a parent node and a child node.}
\label{correlation}
\end{figure}
