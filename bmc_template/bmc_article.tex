...
\begin{algorithmic}
\STATE \COMMENT{Step 1: Identify the two child nodes of the root \textbf{X}, denoted by \textbf{L} and \textbf{R}. Correspondingly, the node times are denoted by $t_X$, $t_L$, $t_R$. The child nodes below them are denoted by \textbf{H1}, \textbf{H2}, \textbf{H3} and \textbf{H4}.}
...
\begin{algorithmic}
\STATE \COMMENT{Step 1: Identify the child node of the root \textbf{X} that has two child nodes below, which is denoted by \textbf{O}. The other child node of the root, which does not have any child nodes and means a heterochronous tip, is denoted by \textbf{Y}. The node times of the root \textbf{X},  \textbf{Y}, \textbf{O} and its child nodes are denoted by ${t_X}$, ${t_Y}$, ${t_O}$, ${t_{G1}}$ and ${t_{G2}}$ respectively.}
\STATE Let \textbf{X} be the root of the tree.
...
\caption{\csentence{Efficiency comparison of clock standard deviation.}}
\label{ucldscalar}
\end{figure}
...
\hline
\multirow{2}*{Data}&\multirow{2}*{Configuration}&Average running&\multirow{2}*{Parameter}&\multirow{2}*{ESS}\\
&&time (hour)&&\\
\hline
\multirow{2}*{Anolis}&Category&0.3788&\multirow{2}*{frequency.A}&698.95\\
&Cons&0.4212&&750.53\\
\hline
\multirow{2}*{RSV2}&Category&2.0509&\multirow{2}*{prior}&1231.32\\
&Cons&2.6742&&3409.88\\
\hline
\multirow{2}*{HIV-1}&Category&2.6040&\multirow{2}*{prior}&387.83\\
&Cons&3.2680&&753.48\\
\hline
\multirow{2}*{Primates}&Category&31.4059&\multirow{2}*{rate.mean}&71.79\\
&Cons&21.6584&&422.24\\
\hline
Simulated data&Category&0.0728&\multirow{2}*{frequency.G}&819.39\\
with 500 sites&Cons&0.0834&&837.50\\
\hline
Simulated data&Category&0.4403&\multirow{2}*{frequency.G}&2760.41\\
with 1000 sites&Cons&0.4863&&2961.67\\
\hline
\end{tabular}
...
\hline
\multirow{2}*{Scenario 1}&10000000&3.2727&8.3e-3&0.5467&\multirow{2}*{3.2669}&\multirow{2}*{1.3e-06}&\multirow{2}*{0.5553}&Figure \ref{res_int}(a)\\
~&20000000&3.271&6.1e-3&0.5616&~&~&~&Figure \ref{res_int}(b)\\
\hline
\multirow{2}*{Scenario 2}&10000000&0.4677&3.9e-04&0.0265&\multirow{2}*{0.4667}&\multirow{2}*{3.5e-05}&\multirow{2}*{0.0262}&Figure \ref{res_int}(c)\\
...
&&Cons&Category&Cons&Category&Cons&Category&Cons&Category&Cons&Category\\
  \hline
\multirow{8}*{rates times}&ConstantDistance Operator&0.2170&-&0.2248&-&0.2228&-&0.2228&-&0.2402&-\\
&Rate Normal Operators$^1$&0.1302&0.2604&0.1349&0.2698&0.1337&0.2674&0.1337&0.2674&0.1441&0.2882\\
&UcldStdev Scale Operator$^2$&0.0260&0.0260&0.0270&0.0270&0.0267&0.0267&0.0267&0.0267&0.0288&0.0288\\
&UcldMean Scale Operator&-&-&-&-&0.0089&0.0089&0.0089&0.0089&-&-\\
&UcldMean Tree UpperDown Operator&-&-&-&-&0.0267&0.0267&0.0267&0.0267&-&-\\
&InternalNodeTime Scale Operator&0.0174&0.0260&0.0180&0.0270&0.0178&0.0267&0.0178&0.0267&0.0192&0.0288\\
&RootAge Scale Operator&0.0174&0.0260&0.0180&0.0270&0.0178&0.0267&0.0178&0.0267&0.0192&0.0288\\
&AllNodeTimes Uniform Operator&0.1910&0.2604&0.1978&0.2698&0.1961&0.2674&0.1961&0.2674&0.2113&0.2882\\
  \hline
\multirow{7}*{Tree}&SubtreeSlide Operator&0.1302&0.1302&0.0989&0.0989&0.1337&0.1337&0.1337&0.1337&0.441&0.1441\\
&NarrowExchange Operator&0.1302&0.1302&0.0989&0.0989&0.1337&0.1337&0.1337&0.1337&0.0480&0.0480\\
&WideExchange Operator&0.0434&0.0434&0.0270&0.0270&0.0267&0.0267&0.0267&0.0267&0.0480&0.0480\\
&WilsonBalding Operator&0.0434&0.0434&0.0270&0.0270&0.0267&0.0267&0.0267&0.0267&0.0480&0.0480\\
&BirthRate Scale Operator&0.0434&0.0434&0.0629&0.0629&-&-&-&-&0.0288&0.0288\\
&DeathRate Scale Operator&-&-&0.0629&0.0629&-&-&-&-&-&-\\
&PopulationSize Scale Operator&-&-&-&-&0.0267&0.0267&0.0267&0.0267&-&-\\
  \hline
\multirow{2}*{Substitution model}&Kappa Scale Operator&0.0087&0.0087&0.0009&0.0009&0.0009&0.0009&0.0009&0.0009&0.0192&0.0192\\
&Frequencies DeltaExchange Operator&0.0017&0.0017&0.0009&0.0009&0.0009&0.0009&0.0009&0.0009&0.0010&0.0010\\
  \hline
