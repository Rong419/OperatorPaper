...
As data sets continue to increase inside, computational efficiency is growing in significance in Bayesian phylogenetic analysis. In this paper, we have discussed a new tree proposal that substantially increases the efficiency of Bayesian phylogenetic inference under the relaxed molecular clock models.

We demonstrate the correctness of this algorithm with a series of tests including a well-calibrated simulation study. Based on both simulated and real data sets, the proposed operator is much more effective and is able to sample the rates and times more efficiently, with performance improvements of greater than an order of magnitude over currently implemented relaxed clock methods in BEAST2. The proposed operator has been developed as an addition to the core of BEAST2. 
