...
\multicolumn{12}{l}{2: The operator introduced in Appendix (UcldstdevScaleOperator) is used in Cons configuration, a Scale operator is used in Category configuration
.}\\
