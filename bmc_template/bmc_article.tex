...
We used a real data set with 83 primates \cite{finstermeier2013mitogenomic} to further evaluate the performance of Constant Distance operator. Similar to the process of simulated data sets, this analysis was performed in three configurations, i.e. categories, cons and nocons. The analysis will also be run 100 times by BEAST2. 
...
\\
\\
In summary, based on comparisons in analysis of both simulated and real data sets, the Constant Distance operator is more effective and able to sample the rates and times more efficiently. And the efficiency can be improved by at least 4 times larger ESS per hour. 
