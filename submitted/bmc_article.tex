...
The resulting summary tree (Figure \ref{withoutdata}(b)) is consistent with previous analyses of this data \cite{cooper2001complete} (Figure \ref{withoutdata}(c)). For large data sets of long sequences, this method may prove useful to provide faster divergence time estimates based on the assumption of known unrooted topology and branch lengths in units of expected substitutions per site.
...
\label{Fig.sub.1}
\includegraphics[width=0.45]{Fig1}}
\subfigure[Senario 1: chain length = 20000000]{
\label{Fig.sub.2}
\includegraphics[width=0.45]{Fig2}}
\subfigure[Senario 2: chain length = 10000000]{
\label{Fig.sub.3}
\includegraphics[width=0.45]{Fig7}}
\subfigure[Senario 2: chain length = 20000000]{
\label{Fig.sub.4}
\includegraphics[width=0.45]{Fig8}}
...
\label{Fig.sub.5}
\includegraphics[width=0.45h]{RplotSD}}
\subfigure[$d_D$ in Small Pulley]{
\label{Fig.sub.6}
\includegraphics[width=0.45]{RplotSP2}}
\subfigure[${d_D}$ in Big pulley]{
\label{Fig.sub.9}
\includegraphics[width=0.45]{bigd}}
\subfigure[${t_E}$ in Big pulley]{
\label{Fig.sub.10}
\includegraphics[width=0.45]{bigT}}
...
\subfigure{
\label{P_ess}
\includegraphics[width=0.45]{primates2.eps}}
\subfigure{
\label{P_run}
\includegraphics[width=0.45]{primates1.eps}}
...
\subfigure[Clades]{
\label{Fig.sub.tree}
\includegraphics[width=0.5]{correlationtree}}
\subfigure[Pairwise compare]{
\label{Fig.sub.correlation}
\includegraphics[width=0.4]{rateandtime.eps}}
...
\label{Fig.sub.11}
\includegraphics[width=0.35]{unrootedtree}}
\subfigure[Rooted time tree]{
\label{Fig.sub.12}
\includegraphics[width=0.4]{initialtree}}
\subfigure[Summary tree of sampled trees]{
\label{summary3}
\includegraphics[width=0.4]{summary3}}
\subfigure[Ratite phylogeography in Ref. \cite{cooper2001complete}]{
\label{ratites}
\includegraphics[width=0.45]{ratites}}
