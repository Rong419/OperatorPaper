...
\label{Fig.sub.1}
\includegraphics[width=0.45]{scenario1S}}
\subfigure[Senario 1: chain length = 20000000]{
\label{Fig.sub.2}
\includegraphics[width=0.45]{scenario1L}}
\subfigure[Senario 2: chain length = 10000000]{
\label{Fig.sub.3}
\includegraphics[width=0.45]{scenario2S}}
\subfigure[Senario 2: chain length = 20000000]{
\label{Fig.sub.4}
\includegraphics[width=0.45]{scenario2L}}
...
\label{Fig.sub.6}
\includegraphics[width=0.45]{RplotSP}}
...
\subfigure{
\label{P_ess}
\includegraphics[width=0.45]{primatesESS.eps}}
\subfigure{
\label{P_run}
\includegraphics[width=0.45]{primatestime.eps}}
...
\label{summary3}
\includegraphics[width=0.4]{summarytree}}
